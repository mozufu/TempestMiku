...
1. **Continue P3+** — the live inbox foundation, child approval routing, pipeline, and actor smoke
   coverage are in place; next tackle restart strategies, wall-clock budgets, subtree cancellation,
