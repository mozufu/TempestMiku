 ...
 * Child approval routing through the live HTTP broker, restart supervision,
 * wall-clock budgets, subtree cancellation, status lifecycle events, and
 * parent-event provenance links are in place.
 */
