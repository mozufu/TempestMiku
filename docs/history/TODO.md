...
> **Archived delivery checklist.** This is the closed implementation ledger that accompanied the
> historical milestone roadmap. It is retained for provenance, not as an active work queue. Read
> [`../PRODUCT.md`](../PRODUCT.md) for the shipped product and [`ROADMAP.md`](ROADMAP.md) for the
> corresponding delivery sequence.
...
[`ROADMAP.md`](ROADMAP.md) is the milestone-order and completion-history source. The memory work is
closed; its implementation, quality metrics, deployment provenance, restart/fallback evidence, and
exact gate matrix live in [`fuller-memory evidence`](../evidence/2026-07-15-p8-5-fuller-memory.md).
...
- [x] **P6.6 / full P6:** exact model activation, airplane-mode cold start, final-build fingerprint,
      ...
      [`2026-07-19-p6-6-android-asr-ab.json`](../evidence/2026-07-19-p6-6-android-asr-ab.json) and
      [`2026-07-19-p6-6-real-speaker-eval.json`](../evidence/2026-07-19-p6-6-real-speaker-eval.json).
- [x] **M4:** the owner selected homolab under the hostile-workload/trusted-host-kernel contract.
      ...
      [production evidence](../evidence/2026-07-19-m4-production-homolab.md).
